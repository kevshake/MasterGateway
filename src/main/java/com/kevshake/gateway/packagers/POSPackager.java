package com.kevshake.gateway.packagers;

import org.jpos.iso.*;

/**
 * Custom POS Packager for incoming POS terminal transactions
 * Based on ISO 8583 v1993 specification - similar to KCBPackager pattern
 */
public class POSPackager extends ISOBasePackager {
    ...
    protected ISOFieldPackager fld[] = {
        ...
        /*039*/ new IFA_NUMERIC(2, "Action code"),
        ...
        /*053*/ new IFB_BINARY(48, "Security related control information"),
        /*054*/ new IFA_LLLCHAR(120, "Amounts, additional"),
        /*055*/ new IFA_LLLBINARY(999, "IC card system related data"),
        /*056*/ new IFA_LLLCHAR(999, "Original data elements"),
        /*057*/ new IFA_LLLCHAR(999, "Authorization life cycle code"),
        /*058*/ new IFA_LLLCHAR(999, "Authorizing agent institution Id Code"),
        ...
        /*064*/ new IFB_BINARY(16, "Message authentication code field"),
        /*065*/ new IFA_BINARY(1, "Reserved for ISO use"),
        /*066*/ new IFA_NUMERIC(1, "Amounts, original fees"),
        ...
        /*082*/ new IFA_NUMERIC(12, "Inquiries, reversal number"),
        /*083*/ new IFA_NUMERIC(12, "Payments, number"),
        /*084*/ new IFA_NUMERIC(12, "Payments, reversal number"),
        /*085*/ new IFA_NUMERIC(12, "Fee collections, number"),
        ...
        /*090*/ new IFA_NUMERIC(42, "Authorizations, reversal number"),
        /*091*/ new IF_CHAR(1, "Country code, transaction Dest. Inst."),
        /*092*/ new IF_CHAR(2, "Country code, transaction Orig. Inst."),
        /*093*/ new IF_CHAR(6, "Transaction Dest. Inst. Id code"),
        /*094*/ new IF_CHAR(7, "Transaction Orig. Inst. Id code"),
        /*095*/ new IFA_LLLCHAR(999, "Card issuer reference data"),
        /*096*/ new IFB_BINARY(16, "Key management data"),
        ...
        /*105*/ new IFA_LLLCHAR(999, "Credits, Chargeback amount"),
        /*106*/ new IFA_LLLCHAR(999, "Debits, Chargeback amount"),
        /*107*/ new IFA_LLLCHAR(999, "Credits, Chargeback number"),
        /*108*/ new IFA_LLLCHAR(999, "Debits, Chargeback number"),
        /*109*/ new IFA_LLLCHAR(999, "Credits, Fee amounts"),
        /*110*/ new IFA_LLLCHAR(999, "Debits, Fee amounts"),
        ...
        /*128*/ new IFB_BINARY(16, "Message authentication code field")
    };
